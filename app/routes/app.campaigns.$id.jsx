...
function Performance({ campaign, comparison, trend }) {
  return <div className="space-y-5">
    <section className="grid grid-cols-2 gap-3 md:grid-cols-4"><SummaryCard label="Likes" value={metric(campaign.metrics.likes)} /><SummaryCard label="Comments" value={metric(campaign.metrics.comments)} /><SummaryCard label="Shares" value={metric(campaign.metrics.shares)} /><SummaryCard label="CTR / CVR" value={`${metric(campaign.metrics.ctr, "rate")} / ${metric(campaign.metrics.cvr, "rate")}`} /></section>
